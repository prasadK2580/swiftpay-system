...
public class IdempotencyCacheEntry {
    ...
    public static IdempotencyCacheEntry processing(PaymentCommand command) {
    ...
    public static IdempotencyCacheEntry completed(String transactionId, PaymentCommand command) {
        IdempotencyCacheEntry entry = processing(command);
    ...
    public static IdempotencyCacheEntry failed(
