...
import com.swiftpay.gateway.service.TransactionStatusUpdateService;
...
public class PaymentSettlementFeedbackListener {

    private final TransactionStatusUpdateService transactionStatusUpdateService;

    public PaymentSettlementFeedbackListener(TransactionStatusUpdateService transactionStatusUpdateService) {
        this.transactionStatusUpdateService = transactionStatusUpdateService;
    }
    ...
    public void onPaymentCompleted(PaymentCompletedEvent event) {
        transactionStatusUpdateService.applyPaymentCompleted(event);
    }
    ...
    public void onPaymentFailed(PaymentFailedEvent event) {
        transactionStatusUpdateService.applyPaymentFailed(event);
    }
}
