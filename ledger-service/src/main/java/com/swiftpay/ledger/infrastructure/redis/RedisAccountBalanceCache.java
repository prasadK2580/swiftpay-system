...
@Component
public class RedisAccountBalanceCache implements AccountBalanceCache {
    ...
    public RedisAccountBalanceCache(StringRedisTemplate stringRedisTemplate, RedisTtlProperties redisTtlProperties) {
